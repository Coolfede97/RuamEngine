...
namespace RuamEngine
{
    ...
    m_velocity(0,0,0), m_mass(1), m_isKinematic(false), m_useGravity(true), m_gravityForce(1.0f)
    {
    ...
    m_velocity(0,0,0), m_mass(1), m_isKinematic(false), m_useGravity(true), m_gravityForce(1.0f)
    {
        ...
        if (rigidbodyData.contains("m_gravityForce")) m_gravityForce = rigidbodyData["m_gravityForce"].get<float>();
    }
    Rigidbody::~Rigidbody()
    {
